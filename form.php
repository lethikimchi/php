...
<?php
    ...
    imagettftext($image, 40, 0, 0.2*$w, 0.3*$h, $red, $font, $firstname . ' ' . $lastname);
    imagettftext($image, 40, 0, 0.2*$w, 0.5*$h, $red, $font, $email);
    imagettftext($image, 40, 0, 0.2*$w, 0.7*$h, $red, $font, 'Tel: ' . $tel);
    ...
    echo '<img src="card_001.jpg" style="width:100%" alt="card"/>';
    ...
    try{
        ...
        $mail->Host = 'smtp.gmail.com';                         // Scecify main and backup servers
		$mail->SMTPAuth = true;									// Enable SMTP authentication
		$mail->Username = 'lekimchisn@gmail.com';				// Gmail username
		$mail->Password = 'kc961101';							// Gmail password
